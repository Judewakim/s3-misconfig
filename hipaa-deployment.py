...
def download_deployment_files():
    ...
    files = [
        ...
        ("dashboard/error.html", "dashboard/error.html"),
        ("lambda/report_generator.py", "lambda/report_generator.py"),
        ("lambda/report_components.py", "lambda/report_components.py"),
        ("lambda/report_styles.py", "lambda/report_styles.py"),
        ("lambda/report_data.py", "lambda/report_data.py"),
    ]
    
    for s3_path, local_path in files:
...
def main():
    ...
    if stack_exists:
        subprocess.run([
            ...
            "--stack-name", "WakimWorksComplianceScanner",
            "--template-body", "file://hipaa-compliance-system.yaml",
            "--region", "us-east-1",
